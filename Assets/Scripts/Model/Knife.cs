...
public class Knife : MonoBehaviour
{
    ...
    {
        //levelController.data.monsterDy = false;
    ...
    private void GetWin()
    {
        levelController.data.monsterDy = true;
        //gameOver = true;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (_knife || _vasya)
        {
            ...
            else if (collision.gameObject.CompareTag("Monster")|| collision.gameObject.CompareTag("Shark"))
            {
        ...
        if (_pepperGas)
        {
            ...
            else if (collision.gameObject.CompareTag("Dark"))
            {
                ...
                collision.gameObject.CompareTag("Bes"))
            {
                MonsterHide();
                levelController.ResetGreenLine();
                levelController.IsPepperGas();
        ...
        if (_air)
        {
            ...
            else if (collision.gameObject.CompareTag("Death") || collision.gameObject.CompareTag("Tank")
                || collision.gameObject.CompareTag("Helik") || collision.gameObject.CompareTag("Ufo")
                || collision.gameObject.CompareTag("Godzy") || collision.gameObject.CompareTag("Avto"))
            {
                levelController.IsMor();
                if (levelController.data.vibro)
                    Handheld.Vibrate();
